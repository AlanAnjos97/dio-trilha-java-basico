...
public class Dev {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((conteudosPendentes == null) ? 0 : conteudosPendentes.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (conteudosInscritos == null) {
            ...
            return false;
        if (conteudosPendentes == null) {
            if (other.conteudosPendentes != null)
                return false;
        } else if (!conteudosPendentes.equals(other.conteudosPendentes))
            return false;
    ...
    public Set<Conteudo> conteudosPendentes() {
        return conteudosPendentes;
    }

    public void conteudosPendentes(Set<Conteudo> conteudosPendentes) {
        this.conteudosPendentes = conteudosPendentes;
    }
